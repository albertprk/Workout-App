...
export const getTrainer = (id) => {
  return dispatch => {
      return axios.get("http://localhost:9000/trainersbackend/gettrainer", {
          params: {
            user: id
          }
      })
...
export const getTrainerByObjectID = (id) => {
  return dispatch => {
      return axios.get("http://localhost:9000/trainersbackend/gettrainerbyobjectid", {
          params: {
            objectid: id
          }
      })
...
export const addTrainer = (Trainer) => {
    return dispatch => {
        axios
            .post("http://localhost:9000/trainersbackend", {
                trainer: Trainer
            })
            .then(res => {
...
export const updateTrainer = (id, trainer) => {
    return dispatch => {
        return axios.put("http://localhost:9000/trainersbackend/updatetrainer", {
              user: id,
              trainer: trainer
        })
            .then((response) => {
