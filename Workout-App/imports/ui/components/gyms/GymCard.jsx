...
class GymCard extends React.Component {
  ...
  render() {
    ...
    return ( <
      ...
      div className = "meta" >
      <
      span className = "cinema" > { this.props.gym.description } <
      /span> <
      /div>
      ...
      div className = "content" >
      <
      a className = "header" > { this.props.gym.name } <
      /a> <
      div className = "meta" >
      <
      span className = "date" >
      ...
      /span> <
      /div> <
      div className = "description" > { this.props.gym.description } <
      /div> <
      /div> <
