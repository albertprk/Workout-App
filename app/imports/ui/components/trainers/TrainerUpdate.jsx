...
class TrainerUpdate extends React.Component {
    ...
    componentDidMount() {
      ...
      if(currentuser && Meteor.user().Trainer) {
        ...
        this.props.history.push("mongodb+srv://m001-student:m001-mongodb-basics@sandbox-kclfx.mongodb.net/workout-app?retryWrites=true&w=majority/account/addtrainer")
      }
    }
